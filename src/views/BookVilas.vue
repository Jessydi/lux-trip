<template>
  <div class="book-supercar-page">
    <main>
      <div class="wrapper">
        <h2>Book Villas/Chalets</h2>
        <BookTransport :bookTransport="bookTransport"></BookTransport>
        <Subscribe></Subscribe>
      </div>
    </main>
  </div>
...
export default {
  components: { BookTransport, Subscribe },
  data() {
    return {
      bookTransport: {
        img: "book-category-3.jpg",
        description: [
        ...
        included: {
          ...
          IBuildings: "Wide selection of cars",
          IWomen: "Exclusive services (e.g.event manager, nanny, etc.)",
